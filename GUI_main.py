...
frame_alpr = tk.LabelFrame(root, text=" --Login & Register-- ", width=595, height=225, bd=5, font=('times', 14, ' bold '),bg="gray")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=630, y=200)
...
label_l1 = tk.Label(root, text="** Drowsiness Detection System @2021 By **",font=("Times New Roman", 10, 'bold'),
