...
#
label_l1 = tk.Label(root, text="Drowsiness  Detection System",font=("Times New Roman", 30, 'bold'),
...
Login_frame=tk.Frame(root,bg="#7D9EC0")
...
button1 = tk.Button(root, text="HOME", command=home, width=12, height=1,font=('times 15 bold underline'),bd=0, bg="#4169E1", fg="white")
button1.place(x=20, y=100)

button2 = tk.Button(root, text="REGISTER",command=reg,width=12, height=1,font=('times 15 bold underline'), bd=0,bg="#4169E1", fg="white")
...
label_l1 = tk.Label(root, text="**Drowsiness Detection System @2023 By __ **",font=("Times New Roman", 10, 'bold'),
