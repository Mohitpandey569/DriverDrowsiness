...
label_l1 = tk.Label(root, text="Drowsiness  Detection System ",font=("Times New Roman", 30, 'bold'),
                    background="#80CCCC", fg="white", width=62, height=2)
...
frame_alpr = tk.LabelFrame(root, text=" --Register-- ", width=600, height=580, bd=5, font=('times', 14, ' bold '),fg="white",bg="#828282")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=700, y=105)
